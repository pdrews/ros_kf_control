...
/******************************
 *Ros node DataAggregator
 *Pulls in all data from laser odometry and boat state
 *and logs it in an interpolated and time-tagged CSV file

 *Collected data:
  - Orientation, X and Y position from laser scans
  - Angular rate and heading from compass
  - Drive commands (twist and left/right)
 *******************************/
